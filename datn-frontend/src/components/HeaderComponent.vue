...
window.onscroll = function () {
    if (window.scrollY >= 104) {
        document.querySelector('.header__menu__wrapper')?.classList.add('fixed-header')
    } else document.querySelector('.header__menu__wrapper')?.classList.remove('fixed-header')
}
...
export default defineComponent({
    ...
    setup() {
        ...
        const isAdmin = JSON.parse(localStorage.getItem('user') as string)?.roleList?.find((role: any) => role === 'ROLE_ADMIN');

        if (localStorage.getItem('token') !== null && localStorage.getItem('loggedIn') === 'true') {
            loggedIn.value = true;
        }
    ...
    <div id="header">
        ...
        <div class="header__main d-flex justify-content-center">
            <div class="container-xl">
                ...
                <ul class="header__main__list" v-if="loggedIn">
                        ...
                        <v-menu>
                            ...
                            <v-list>
                                <v-list-item
                                    ...
                                    :value="index"
                                >
                                    <v-list-item-title @click="redirect(item?.path)">{{
                                            item.title
                                        }}
                                    </v-list-item-title>
                                </v-list-item>
        ...
        <!-- Header menu -->
        <div class="header__menu__wrapper hide-on-mobile">
            <div class="header__menu container-xxl">
                <ul class="header__menu__list">
                    ...
                    <li class="header__menu__item">
                        <RouterLink to="/post" class="header__menu__item__link"> Tin tức</RouterLink>
                    </li>
                    <li class="header__menu__item">
                        <RouterLink to="/about" class="header__menu__item__link"> Giới thiệu</RouterLink>
                    </li>
                    <li class="header__menu__item">
                        <RouterLink to="" class="header__menu__item__link"> Liên hệ</RouterLink>
                    </li>
                </ul>
            </div>
        </div>
