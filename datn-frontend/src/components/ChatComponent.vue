                ...
                <div class="card chat-app">
                    <div id="plist" class="people-list">
                        ...
                        <ul class="list-unstyled chat-list mt-2 mb-0">
                            <li class="clearfix" v-for="(item,index) in admins" :key="index" @click.prevent="setAdminSelected(item)" :class="{'active' : adminSelected?.username === item?.username}">
                    ...
                    <div class="chat">
                        <div class="chat-header clearfix">
                            <div class="row">
                                <div class="col-lg-6">
                                    <a>
                                        <v-avatar :image="'data:image/png;base64,' + adminSelected.avatar" size="30" class="border-dark"></v-avatar>
                                    </a>
                                    <div class="chat-about">
                                        <h6 class="m-b-0">{{adminSelected.username}}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default defineComponent({
    ...
    methods: {
        ...
        async getMessages() {
            this.messageList = await this.chatService.getMessages(this.adminSelected?.id);
           // xử lý bất đồng bộ
        },
