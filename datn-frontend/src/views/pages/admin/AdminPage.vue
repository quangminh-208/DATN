      ...
      <div class="col-auto col-md-3 col-xl-2 p-0 bg-dark">
        ...
        >
          <div class="w-100 bg-primary">
            ...
            >
              <span class="fs-5 d-none d-sm-inline text-uppercase fw-bold"
                >Dashboard</span
              >
            </a>
          </div>
          <ul
            class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start overflow-auto min-vh-100"
            id="menu"
          >
            <li class="nav-item px-4">
              <a
                ...
                @click.prevent="$router.push('/admin/chart')"
              >
            ...
            <li class="px-4">
              ...
              >
                ...
                >
                  <a
                    class="nav-link px-0 d-flex m-3"
                    @click.prevent="$router.push(item.routerLink)"
                    role="button"
                  >
                    <span class="d-none d-sm-inline" :title="item.label">{{
                      item.label
                    }}</span>
                  </a>
                </li>
          ...
          <div
            class="user-wrapper dropdown bg-primary col-auto col-md-3 col-xl-2"
          >
            <a
              href="#"
