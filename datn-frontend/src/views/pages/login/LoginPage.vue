...
<template>
  <section class="vh-100">
        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <div class="row justify-content-center mb-5">
            <img
              ...
              class="header__main__logo__img img-fluid col-9"
            />
          </div>
    ...
    <div
      class="d-flex flex-column flex-lg-row text-center justify-content-between py-4 px-4 bg-primary"
    >
      <!-- Copyright -->
      ...
      <div class="fs-2">
        <RouterLink to="">
          <i class="fa fa-facebook-square mx-2 text-white"></i>
        </RouterLink>
        <RouterLink to="">
          <i class="fa fa-twitter mx-2 text-white"></i>
        </RouterLink>
        <RouterLink to="">
          <i class="fa fa-linkedin-square mx-2 text-white"></i>
        </RouterLink>
      </div>
    </div>
  </section>
